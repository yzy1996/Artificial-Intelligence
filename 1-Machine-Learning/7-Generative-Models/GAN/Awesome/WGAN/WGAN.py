...
# # clip
# generator_gradient = tf.clip_by_value(generator_gradient, -0.01, 0.01)
# discriminator_gradient = tf.clip_by_value(discriminator_gradient, -0.01, 0.01)
...
def train_step(images):
    ...
    for _ in range(5):
        ...
        with tf.GradientTape() as disc_tape:
            ...
            generated_images = generator(noise, training=False) # fix generator
    ...
    with tf.GradientTape() as gen_tape:
        ...
        fake_output = discriminator(generated_images, training=False) # fix discriminator
