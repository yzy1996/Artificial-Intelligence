...
# 创建输出文件夹
OUTPUT_PATH = Path('./Output_CelebA_DCGAN_Pytorch')
...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=FILTER_NUM * 8,
            ...
            nn.ConvTranspose2d(in_channels=FILTER_NUM * 4,
...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv2d(in_channels=FILTER_NUM * 4,
                      out_channels=FILTER_NUM * 8,
                      kernel_size=4,
                      stride=2,
                      padding=1,
            ...
            nn.Conv2d(in_channels=FILTER_NUM * 8,
                      out_channels=1,
                      kernel_size=4,
                      stride=1,
                      padding=0,
...
data_train = datasets.dset.ImageFolder(root=dataroot,
                                       transform=transform)
...
torch.save(generator, OUTPUT_PATH / 'CelebA_DCGAN.pkl')
